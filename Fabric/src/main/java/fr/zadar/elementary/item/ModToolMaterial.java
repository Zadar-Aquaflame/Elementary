...
public enum ModToolMaterial implements ToolMaterial {
    ...
    AERITHIUM(4, 860, 3f, 5f, 17, () -> Ingredient.ofItems(ModItems.AERITHIUM_INGOT)),

    EMBERITE(5, 1450, 5f, 6f, 20, () -> Ingredient.ofItems(ModItems.EMBERITE_INGOT)),
    AQUALITE(5, 1600, 4.5f, 6f, 20, () -> Ingredient.ofItems(ModItems.AQUALITE_INGOT)),
    AERILITE(5, 1470, 4.5f, 6f, 20, () -> Ingredient.ofItems(ModItems.AERILITE_INGOT));
