...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    AERITHIUM("aerithium", 25, new int[]{4, 7, 6, 5}, 17,
            SoundEvents.ARMOR_EQUIP_ELYTRA, 1f, 0.1f, () -> Ingredient.of(ModItems.AERITHIUM_INGOT.get())),
    ...
    AERILITE("aerilite", 27, new int[]{5, 7, 6, 4}, 20,
            SoundEvents.ARMOR_EQUIP_ELYTRA, 1f, 0.3f, () -> Ingredient.of(ModItems.AERILITE_INGOT.get()));
