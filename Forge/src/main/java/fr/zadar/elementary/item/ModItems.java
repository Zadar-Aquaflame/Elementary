...
public class ModItems {
    ...
    public static final RegistryObject<Item> EMBERSTONE_PICKAXE = ITEMS.register("emberstone_pickaxe",
            () -> new PickaxeItem(ModToolTiers.EMBERSTONE, 0, -2.8f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERSTONE_AXE = ITEMS.register("emberstone_axe",
            () -> new AxeItem(ModToolTiers.EMBERSTONE, 7, -3.1f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERSTONE_SHOVEL = ITEMS.register("emberstone_shovel",
            () -> new ShovelItem(ModToolTiers.EMBERSTONE, 0.5f, -3.0f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERSTONE_HOE = ITEMS.register("emberstone_hoe",
            () -> new HoeItem(ModToolTiers.EMBERSTONE, -4, -1.0f, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> HYDROSTONE_PICKAXE = ITEMS.register("hydrostone_pickaxe",
            () -> new PickaxeItem(ModToolTiers.HYDROSTONE, 0, -2.8f, new Item.Properties()));
    public static final RegistryObject<Item> HYDROSTONE_AXE = ITEMS.register("hydrostone_axe",
            () -> new AxeItem(ModToolTiers.HYDROSTONE, 8, -3.1f, new Item.Properties()));
    public static final RegistryObject<Item> HYDROSTONE_SHOVEL = ITEMS.register("hydrostone_shovel",
            () -> new ShovelItem(ModToolTiers.HYDROSTONE, 0.5f, -3.0f, new Item.Properties()));
    public static final RegistryObject<Item> HYDROSTONE_HOE = ITEMS.register("hydrostone_hoe",
            () -> new HoeItem(ModToolTiers.HYDROSTONE, -6, -1.0f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> AERITHIUM_INGOT = ITEMS.register("aerithium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> RAW_AERITHIUM = ITEMS.register("raw_aerithium", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> AERITHIUM_SWORD = ITEMS.register("aerithium_sword",
            () -> new SwordItem(ModToolTiers.AERITHIUM, 6, -2.8f, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_PICKAXE = ITEMS.register("aerithium_pickaxe",
            () -> new PickaxeItem(ModToolTiers.AERITHIUM, 0, -3.0f, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_AXE = ITEMS.register("aerithium_axe",
            () -> new AxeItem(ModToolTiers.AERITHIUM, 8, -3.1f, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_SHOVEL = ITEMS.register("aerithium_shovel",
            () -> new ShovelItem(ModToolTiers.AERITHIUM, 0.5f, -3.0f, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_HOE = ITEMS.register("aerithium_hoe",
            () -> new HoeItem(ModToolTiers.AERITHIUM, -5, -1.0f, new Item.Properties()));

    public static final RegistryObject<Item> AERITHIUM_HELMET = ITEMS.register("aerithium_helmet",
            () -> new ArmorItem(ModArmorMaterial.AERITHIUM, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_CHESTPLATE = ITEMS.register("aerithium_chestplate",
            () -> new ArmorItem(ModArmorMaterial.AERITHIUM, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_LEGGINGS = ITEMS.register("aerithium_leggings",
            () -> new ArmorItem(ModArmorMaterial.AERITHIUM, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> AERITHIUM_BOOTS = ITEMS.register("aerithium_boots",
            () -> new ArmorItem(ModArmorMaterial.AERITHIUM, ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> HURRICANE_FRAGMENT = ITEMS.register("hurricane_fragment", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> STORM_ESSENCE = ITEMS.register("storm_essence", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> SPARK_EMERALD = ITEMS.register("spark_emerald", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> POND_EMERALD = ITEMS.register("pond_emerald", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> SQUALL_EMERALD = ITEMS.register("squall_emerald", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> EMBERITE_PICKAXE = ITEMS.register("emberite_pickaxe",
            () -> new PickaxeItem(ModToolTiers.EMBERITE, 2, -2.8f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERITE_AXE = ITEMS.register("emberite_axe",
            () -> new AxeItem(ModToolTiers.EMBERITE, 7, -3.1f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERITE_SHOVEL = ITEMS.register("emberite_shovel",
            () -> new ShovelItem(ModToolTiers.EMBERITE, 2.5f, -3.0f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> EMBERITE_HOE = ITEMS.register("emberite_hoe",
            () -> new HoeItem(ModToolTiers.EMBERITE, -6, -1.0f, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> AQUALITE_PICKAXE = ITEMS.register("aqualite_pickaxe",
            () -> new PickaxeItem(ModToolTiers.AQUALITE, 2, -2.8f, new Item.Properties()));
    public static final RegistryObject<Item> AQUALITE_AXE = ITEMS.register("aqualite_axe",
            () -> new AxeItem(ModToolTiers.AQUALITE, 7, -3.1f, new Item.Properties()));
    public static final RegistryObject<Item> AQUALITE_SHOVEL = ITEMS.register("aqualite_shovel",
            () -> new ShovelItem(ModToolTiers.AQUALITE, 2.5f, -3.0f, new Item.Properties()));
    public static final RegistryObject<Item> AQUALITE_HOE = ITEMS.register("aqualite_hoe",
            () -> new HoeItem(ModToolTiers.AQUALITE, -6, -1.0f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> AERILITE_INGOT = ITEMS.register("aerilite_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> AIR_FERROCRYSTAL_INGOT = ITEMS.register("air_ferrocrystal_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> AIR_FERROCRYSTAL_STICK = ITEMS.register("air_ferrocrystal_stick", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> AERILITE_SWORD = ITEMS.register("aerilite_sword",
            () -> new SwordItem(ModToolTiers.AERILITE, 5, -2.4f, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_PICKAXE = ITEMS.register("aerilite_pickaxe",
            () -> new PickaxeItem(ModToolTiers.AERILITE, 2, -2.8f, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_AXE = ITEMS.register("aerilite_axe",
            () -> new AxeItem(ModToolTiers.AERILITE, 7, -3.1f, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_SHOVEL = ITEMS.register("aerilite_shovel",
            () -> new ShovelItem(ModToolTiers.AERILITE, 2.5f, -3.0f, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_HOE = ITEMS.register("aerilite_hoe",
            () -> new HoeItem(ModToolTiers.AERILITE, -6, -1.0f, new Item.Properties()));

    public static final RegistryObject<Item> AERILITE_HELMET = ITEMS.register("aerilite_helmet",
            () -> new ArmorItem(ModArmorMaterial.AERILITE, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_CHESTPLATE = ITEMS.register("aerilite_chestplate",
            () -> new ArmorItem(ModArmorMaterial.AERILITE, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_LEGGINGS = ITEMS.register("aerilite_leggings",
            () -> new ArmorItem(ModArmorMaterial.AERILITE, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> AERILITE_BOOTS = ITEMS.register("aerilite_boots",
            () -> new ArmorItem(ModArmorMaterial.AERILITE, ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> AERORUPTURA_SPAWN_EGG = ITEMS.register("aeroruptura_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.AERORUPTURA, 0xEEEFFF, 0x555555, new Item.Properties()));
