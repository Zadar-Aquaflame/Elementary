...
public class BiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_AERITHIUM_ORE = registerKey("add_aerithium_ore");
    ...
    public static final ResourceKey<BiomeModifier> ADD_AIR_CRYSTAL_ORE = registerKey("add_air_crystal_ore");
    ...
    public static final ResourceKey<BiomeModifier> SPAWN_AERORUPTURA = registerKey("spawn_aeroruptura");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_AERITHIUM_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(PlacedFeatures.AERITHIUM_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_AIR_CRYSTAL_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(PlacedFeatures.AIR_CRYSTAL_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(SPAWN_AERORUPTURA, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                List.of(new MobSpawnSettings.SpawnerData(ModEntities.AERORUPTURA.get(), 64, 1, 1))));
    }
